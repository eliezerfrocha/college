...
public class ProdutoController {
    ...
    public ResponseEntity<List<ProdutoDto>> listarProdutosComMaiorPrecoPorCategoria() {
        // List<Produto> produtos = repository.findProdutosComMaiorPrecoPorCategoria();
        List<ProdutoDto> produtos = repository.findProdutosComMaiorPrecoPorCategoria();
