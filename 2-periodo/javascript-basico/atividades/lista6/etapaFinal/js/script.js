// Jogo da memória - implementação completa para as etapas finais
(function(){
    ...
    function clearBoard(){
        ...
        tentativasEl.textContent = '0'; acertosEl.textContent='0'; aproveitamentoEl.textContent='0%'; timerEl.textContent='00:00';
    ...
    function renderBoard(deckArr){
        ...
        deckArr.forEach((num, idx) => {
            ...
            // images are in etapa4/img
            img.src = `../etapa4/img/carta${num}.png`;
            img.alt = `carta ${num}`;
    ...
    function onCardClick(e){
        ...
        if(card === firstCard) { showMessage('Clique em outra carta diferente da primeira.'); return; }
        if(card.classList.contains('flipped')) return; // ignore double clicks
